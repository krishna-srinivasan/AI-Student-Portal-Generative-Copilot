...
//       // Check if the backend returned an empty array
//       if (response.data.documents && response.data.documents.length > 0) {
//         setMemories(response.data.documents); 
//       } else {
//         // FORCING THE UI TO SHOW YOUR PDF IF BACKEND IS EMPTY
//         setMemories([
//           { id: 1, filename: "My_Recently_Uploaded_File.pdf", uploadDate: "2026-07-26" }
//         ]);
//       }

//     } catch (err) {
//       console.log("Failed to load memories:", err);
//       // Also show it if the connection completely fails
//       setMemories([
//         { id: 1, filename: "My_Recently_Uploaded_File.pdf", uploadDate: "2026-07-26" }
//       ]);
//     } finally {
...
//       <h2 style={{ color: "#00d4ff", marginBottom: "10px", fontSize: "2rem" }}>🧠 AI Memory Base</h2>
//       <p style={{ color: "#9fb6d6", fontSize: "1rem", marginBottom: "30px" }}>Manage the documents and files providing context to your AI assistant.</p>

//       {loading ? (
//         <div style={{ color: "#00d4ff", textAlign: "center", padding: "20px" }}>Scanning memory banks...</div>
//       ) : memories.length === 0 ? (
...
//           {memories.map((doc) => (
//             <div key={doc.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "#121a30", padding: "20px", borderRadius: "12px", border: "1px solid rgba(0, 255, 255, 0.1)", boxShadow: "0 4px 15px rgba(0, 0, 0, 0.15)" }}>
...
//                 style={{ background: "rgba(255, 60, 111, 0.1)", color: "#ff3c6f", border: "1px solid rgba(255, 60, 111, 0.3)", padding: "8px 12px", borderRadius: "8px", cursor: "pointer", transition: "0.2s" }}
//                 onMouseOver={(e) => { e.target.style.background = "#ff3c6f"; e.target.style.color = "white"; }}
//                 onMouseOut={(e) => { e.target.style.background = "rgba(255, 60, 111, 0.1)"; e.target.style.color = "#ff3c6f"; }}
//               >
//                 Delete
//               </button>
//             </div>
...
//     } catch (err) {
//       console.log("Failed to load memories:", err);
//       // Stay empty if there is an error fetching from backend
//       setMemories([]); 
//     } finally {
//       setLoading(false);
//     }
